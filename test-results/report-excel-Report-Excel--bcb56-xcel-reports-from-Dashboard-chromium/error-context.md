...
- Name: report-excel.spec.ts >> Report Excel Downloads >> Admin should be able to download Excel reports from Dashboard
- Location: tests\e2e\report-excel.spec.ts:15:5
...
- generic [ref=e4]:
  - generic [ref=e5]: "403"
  - generic [ref=e6]: Unauthorized action.
```
